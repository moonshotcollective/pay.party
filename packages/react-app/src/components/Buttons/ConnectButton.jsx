...
import { Menu, MenuButton, Avatar, MenuList, MenuItem, MenuDivider, useColorModeValue } from "@chakra-ui/react";
...
function ConnectButton() {
  const { authenticate, isAuthenticated, user, logout, enableWeb3, isWeb3Enabled, Moralis, web3 } = useMoralis();
